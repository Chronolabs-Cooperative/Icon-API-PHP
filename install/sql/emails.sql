...
CREATE TABLE `emails` (
  ...
  `format-id` mediumint(200) NOT NULL DEFAULT '0',
  `original-id` mediumint(200) NOT NULL DEFAULT '0',
  `image-id` mediumint(200) NOT NULL DEFAULT '0',
  `unixname` varchar(255) NOT NULL DEFAULT '',
  `tos` tinyblob,
  `ccs` tinyblob,
  `bccs` tinyblob,
  `subject` varchar(255) NOT NULL DEFAULT '',
  `from-name` varchar(128) NOT NULL DEFAULT '',
  `from-email` varchar(255) NOT NULL DEFAULT '',
  `body` mediumtext,
